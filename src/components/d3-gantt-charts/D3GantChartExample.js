...
import D3GantChartsFactory from './D3GantChartsFactory'

const D3GantChartExample = () => {
...
const tasks = [
  ...
  const taskNames = ["D Job", "P Job", "E Job", "A Job", "N Job"];
    return (
        <div>
            <D3GantChartsFactory tasks={tasks} tickFormat={'%H:%M'} taskTypes={taskNames} taskStatus={taskStatus} />
        </div>
    )
}

export default D3GantChartExample
